...
{
    /// <inheritdoc />
    public partial class InitialPostgresState : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TargetMonthlyRevenue = table.Column<decimal>(type: "numeric", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QuoteTemplateId = table.Column<string>(type: "text", nullable: true),
                    QuoteOpenedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<int>(type: "integer", nullable: false),
                    PortalToken = table.Column<Guid>(type: "uuid", nullable: false),
                    ...
                    SignerIp = table.Column<string>(type: "text", nullable: true),
                    ViewedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true),
                    HasBeenViewed = table.Column<bool>(type: "boolean", nullable: false),
                    BaseRetainer = table.Column<decimal>(type: "numeric", nullable: false),
                    SuccessFeeType = table.Column<int>(type: "integer", nullable: false),
                    SuccessFeeValue = table.Column<decimal>(type: "numeric", nullable: false),
                    LastInvoicedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true),
                    Version = table.Column<int>(type: "integer", nullable: false),
                    SignatureStatus = table.Column<string>(type: "text", nullable: false),
                    IsWaitingSignature = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    ProjectId = table.Column<Guid>(type: "uuid", nullable: false),
                    AdAccountId = table.Column<Guid>(type: "uuid", nullable: true),
                    Platform = table.Column<int>(type: "integer", nullable: false),
